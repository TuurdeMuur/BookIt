...
<?php if ($product['name'] == "papieren versie") {
  ...
  <input type='radio' name='product_id' value='41' id='12'> <label for='12'>periode 12 maand: 15,95 euro/maand</label> <br>
  ...
  echo "</section>";
    ...
    echo "</div>";
    echo "<form action='index.php?page=mandje' method='post'>
    <input type='radio' name='product_id' value='44' id='12'> <label for='12'>periode 12 maand: 15,95 euro/maand</label> <br>
    ...
    echo "<p>kleur</p>";
    echo "<form action='index.php?page=mandje' method='post'>
    <input type='radio' name='product_id' value='38' id='12'> <label for='12'>rood</label> <br>
    ...
    echo "<form action='index.php?page=mandje' method='post'>
    <p>kleur</p>
    <input name='product_id' value='34' type='radio' id='12'> <label for='12'>rood</label> <br>
    ...
    echo "<form action='index.php?page=mandje' method='post'>
    <p>kleur</p>
    <input name='product_id' type='radio' id='12' value=" . $product['e-id'] . "> <label for='12'>e-reader versie: 1,99 euro</label> <br>
