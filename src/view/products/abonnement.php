...
<div class="title__wrapper">
  <h2 class="section__title" >HUMO-abonnement</h2>
  </div>
  <div class="sub-wrapper">
<article class="sub__item papier">
<picture class="sub__item--img">
<source
   ...
   srcset ="../assets/abonnementSmall.png"
   >
   <img class="product__img" src="../assets/abonnementMedium.png" alt="papier">
   </picture>
...
<source
   media="(max-width: 400px)"
   srcset ="../assets/humodigitaalTiny.png"
   >
   <source
   media="(max-width: 660px)"
   srcset ="../assets/humodigitaal.png"
   >
   <source
   media="(max-width: 1250px)"
   srcset ="../assets/humodigitaalTiny.png"
   >
   <img class="product__img" src="../assets/humodigitaal.png" alt="digitaal">
   </picture>
